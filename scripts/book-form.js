      ...
      <div class="book-head">
        ...
        <form id="book-form" novalidate>
          ...
          <div class="fstep" data-step="3">
            ...
            <div class="form-row">
              <label for="f-files">Previous surveys or photos <span class="opt">(optional)</span></label>
              <input id="f-files" name="Files" type="file" multiple
                accept="image/jpeg,image/png,image/heic,image/webp,application/pdf" />
              <p class="file-hint">Up to 5 photos or PDFs. Large photos are shrunk before
                sending, so a picture straight off your phone is fine. An earlier report or a
