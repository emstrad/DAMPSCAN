/* Water Damage, ati. Written from this site's position, not shared with the other.
   See scripts/service-template.js for why the pair are two documents.

   ATi undertakes no remedial work, so this is not drying, strip out or repair.
   It is the report: what happened, when, and whether the damage in front of you
   is the escape of water or something that was already there. That question is
   what insurers decline claims on, which is where the instructions come from. */
export default {
  slug: 'water-damage',
  site: 'ati',
  name: 'Water Damage',
  title: 'Water Damage Surveys in London | ATi Damp Survey',
  metaDescription:
    'Independent water damage and escape of water surveys across London. Reports for insurance claims, declined claims and leaks between flats.',
  h1: 'Water damage: what happened, when, and whether the claim stands up',
  intro:
  ...
  signsHeading: 'When an independent report changes the outcome',
  signs: [
  ...
  sections: [
    {
      h2: 'Sudden or gradual, and why the whole claim turns on it',
      paras: [
    ...
    {
      h2: 'Where the water actually came from',
      paras: [
    ...
    {
      h2: 'Why the report has to come from somewhere neutral',
      paras: [
        ...
        'Fixed fee agreed before we attend, and the written report within 24 hours of the inspection. Many policies include trace and access cover which may meet part of the cost, so it is worth checking your wording before you assume the fee is yours.',
      ]
    },
  ],
  ctaHeading: 'Get the water damage established properly',
  ctaBody:
    'An independent inspection and a written report within 24 hours, with readings taken to depth, the source identified and a clear opinion on timing. Put your postcode in the form and we will confirm cover and fee the same day.',
  faq: [
    {
      q: 'My insurer says the damage is gradual, not a sudden escape. Can that be challenged?',
      a:
    ...
    {
      q: 'Water is coming from the flat above. Whose insurance deals with it?',
      a:
    ...
    {
      q: 'Do you dry the property or carry out the repairs?',
      a:
